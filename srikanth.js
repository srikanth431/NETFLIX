// Consts
const apikey = "e1e5e9c98f21aa3bcc94ff283273253b";
...
function searchMovieTrailer(movieName, iframId) {
    ...
    .then(res => {
        ...
        const div = document.createElement('div');
        div.innerHTML = `<iframe width="245px" height="150px" src=""></iframe>`
